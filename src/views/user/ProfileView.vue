						...
						<div id="profile_div">
							<div class="d-flex flex-column align-items-center" id="profile_upper" style="position: relative">
								<div class="profile-image-area">
									<img :src="userInfo.profile ? userInfo.profile : '/src/assets/image/default_profile_img.png'" id="profileImage" >
									
								</div>
								<div class="profile-btn-area mt-3">
									<button type="button" class="btn btn-outline-secondary btn-sm me-1">이미지 선택</button>
							...
							<div class="mt-3" id="info_upper">
								<div class="d-flex flex-row mb-3">
									<label style="width: 100px">이름</label> <input
										class="p-1 mb-3 ms-1" type="text" id="mypage_name"
										name="userName"
								...
								<div class="d-flex flex-row mb-3">
									<label style="width: 100px">이메일</label> <input
										class="p-1 mb-3 ms-1" type="email" id="mypage_email"
										name="useremail"
										style="width: 100%; text-align: right"
										v-model="email"
										required />
								...
								<div class="d-flex flex-row mb-5">
									<label style="width: 100px">비밀번호</label> <input
										class="p-1 mb-3 ms-1" type="password" id="mypage_pwd"
										name="userpwd"
										style="width: 100%; text-align: right"
										v-model="pw"
										required />

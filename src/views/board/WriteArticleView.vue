...
const boardInsert = async function() {
    await axios.post('http://localhost/article', {
        memberId: 'minsun01',
...
<template>
    <div class="position-relative">
		...
		<form action="" method="POST" class="editor__form mb-3 position-absolute top-50 start-50 translate-middle-x"
			id="editor-form" style="width: 45%" @submit.prevent="boardInsert">
			...
			<div class="d-flex flex-row mb-3 mt-3">
				<label style="width: 90px">제목</label> <input
                    ...
                    v-model="subject" style="width: 100%" value="" required />
			</div>
			<div class="d-flex flex-row mb-3">
				...
				<textarea rows="10"
					...
					style="width: 100%" value="" v-model="content" required></textarea>
			</div>

...
<template>
    <div class="position-relative">
		...
		<form action="" method="POST" class="editor__form mb-3 position-absolute top-50 start-50 translate-middle-x"
			id="editor-form" style="width: 45%" @submit.prevent="contentUpdate">
			...
			<div class="d-flex flex-row mb-3 mt-3">
				<label style="width: 90px">제목</label> <input
					...
					style="width: 100%" v-model="subject"  >
			</div>
			<div class="d-flex flex-row mb-3">
				...
				<textarea rows="10"
					...
					style="width: 100%" v-model="content" ></textarea>
			</div>
			...
			<div class="d-flex justify-content-center">
                ...
                <RouterLink :to="{ name: 'board' }" style="text-decoration: none;"><span class="mb-3 text-primary" style="cursor: pointer">
				    <button type="button" class="btn btn-outline-primary" onclick=''>수정 취소</button></span>
                </RouterLink>
			</div>

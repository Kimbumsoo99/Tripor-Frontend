            ...
            <div id="upper_div">
                    ...
                    <div id="makeplan_div" class="d-none d-xl-block"></div>
						...
						<div class="d-flex flex-row" id="makePlace">
								<input class="form-control mr-sm-2 w-75 shadow-sm"
									type="search" placeholder="여행지를 검색하세요!" aria-label="Search"
									id="searchInput" />
                                <div style="width: 5px"></div>
								<button class="btn text-white btn-primary" type="button"
						...
						<button type="button" id="savePlanButton"
							class="btn btn-outline-primary mt-auto">일정 등록하기</button>
                        <div style="height: 5px"></div>
						<button type="button" id="canclePlanButton"
							class="btn btn-outline-danger mt-auto">일정 초기화</button>
                        </div>
				</div>
                </div>
